        ...
        <div class="card-body d-flex justify-content-between align-items-center">
            <div>
                ...
                <small class="text-muted">
                    Created on {{ optional($task->created_at)->format('d M Y, h:i A') ?? '-' }}
                </small>
            </div>
            ...
            <table class="table table-hover align-middle mb-0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-4">{{ optional($task->user)->name ?? '-' }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="px-4">{{ optional($task->start_time)->format('d M Y, h:i A') ?? '-' }}</td>
                    </tr>
                    <tr>
                        <th class="w-25 text-muted fw-medium px-4">End Time</th>
                        <td class="px-4">{{ optional($task->end_time)->format('d M Y, h:i A') ?? '-' }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="px-4">{{ optional($task->started_at)->format('d M Y, h:i A') ?? '-' }}</td>
                    </tr>
                    <tr>
                        <th class="w-25 text-muted fw-medium px-4">Completed At</th>
                        <td class="px-4">{{ optional($task->completed_at)->format('d M Y, h:i A') ?? '-' }}</td>
                    </tr>
                    <tr>
